...
public final class MockWorkoutRepository: WorkoutRepository {
    ...
    private var workouts: [WorkoutRecord] = [
        WorkoutRecord(documentID: "100001", name: "Biceps", startDate: .distantPast, endDate: .distantFuture, duration: 500, notes: "best bicep workout", exercises: [
            ExerciseRecord(documentID: "7000001", template: .mock_1, sets: [.init(exerciseID: UUID(), weight: 5, rep: 12), .init(exerciseID: UUID(), weight: 7.5, rep: 10), .init(exerciseID: UUID(), weight: 10, rep: 8)]),
            ExerciseRecord(documentID: "7000002", template: .mock_1, sets: [.init(exerciseID: UUID(), weight: 5, rep: 12), .init(exerciseID: UUID(), weight: 7.5, rep: 10), .init(exerciseID: UUID(), weight: 10, rep: 8)])
        ])
    ]
